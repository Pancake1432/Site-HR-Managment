...
export const allCompanyData: Record<string, CompanyDataset> = {
  ...
  'company-swift': {
    ...
    companyDrivers: [
      ...
      { id: 4, name: 'Diana Petrov',    firstName: 'Diana',    lastName: 'Petrov',   position: 'Owner Operator', equipment: 'Any',      status: 'Applied',        date: '03/10/2024', isEmployee: true, driverStatus: 'Ready',     paymentType: 'percent', employmentStatus: 'Working' },
  ...
  'company-eagle': {
    ...
    companyDrivers: [
      ...
      { id: 4, name: 'Clara Hoffmann',  firstName: 'Clara',    lastName: 'Hoffmann', position: 'Owner Operator', equipment: 'Any',      status: 'Applied',        date: '04/09/2024', isEmployee: true, driverStatus: 'Ready',     paymentType: 'percent', employmentStatus: 'Working' },
    ],
    applicants: [
...
/** Returns the dataset for the given companyId, falling back to Paks if unknown */
export function getCompanyData(companyId: string) {
  return allCompanyData[companyId] ?? allCompanyData['company-paks'];
}
